  ...
  return (
    <>
      <section className="grid lg:bg-black-secondary rounded-xl ">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:px-8 lg:py-10 xl:p-16 lg:items-center">
          <img
            ...
            alt=""
          />
          <div className="grid gap-8 lg:pr-14">
            ...
            <div className="grid gap-4 lg:rounded-full xl:flex xl:bg-white xl:justify-between xl:rounded-3xl xl:h-[60px] ">
              <input
                ...
                type="email"
                name="email"
                className="rounded-full lg:w-full xl:rounded-3xl flex gap-3 px-5 py-3" 
              />
              <div className="flex gap-3 py-3 px-5 justify-center items-center rounded-full lg:rounded-2xl bg-purple text-base font-semibold leading-6" onClick={onClick}>
