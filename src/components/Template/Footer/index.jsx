        ...
        <div className="grid gap-5 my-4">
          ...
          <div className="grid gap-4 lg:flex lg:bg-white lg:rounded-full lg:justify-between lg:max-w-md xl:max-w-none xl:rounded-2xl">
            <input
              ...
              type="email"
              name="email"
              className="rounded-full w-full lg:rounded-2xl flex gap-3 px-5 py-4 bg-white items-center"
            />
            <button className="bg-purple rounded-full h-14 lg:rounded-2xl xl:px-4 xl:py-8 inline-flex px-12 justify-center items-center gap-3 flex-shrink-0 text-white transition-transform duration-300 ease-in-out transform hover:scale-90">
              Subscribe
            </button>
          </div>
        </div>
