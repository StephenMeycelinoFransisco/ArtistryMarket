...
export default function Artist() {
  return (
    <div className="relative rounded-xl bg-black-secondary p-[1.25rem] xl:w-[15rem] text-white mx-auto">
      <div className="flex gap-[1.25rem] xl:grid xl:justify-center xl:text-center">
        <div className="relative">
          <span className="absolute -top-2 -left-1 bg-black rounded-full text-gray text-xs xl:text-base font-bold p-2">
            1
          </span>
          <img
            className="w-[3.75rem] rounded-full xl:mx-auto xl:w-[7.5rem]"
        ...
        <div className="grid items-center">
          <h1 className="m-0 p-0 xl:mb-2">Dish Studio</h1>
