...
export default function Category() {
  return (
    <div className="overflow-hidden bg-black-secondary rounded-xl max-w-[8.875rem] xl:w-[15rem] text-white mx-auto">
      <div className="relative">
        <img
          className="w-[142px] h-[142px] object-cover object-center mx-auto blur-sm xl:w-[15rem] xl:h-[15rem]"
      ...
      <div className="p-[1.25rem] mb-2">
        <h1 className="font-semibold leading-[140%] text-[1rem] font-workSans xl:text-[1.375rem] ">
          Category
        </h1>
      </div>
    </div>
