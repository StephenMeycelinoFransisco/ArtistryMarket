...
export default function NFT() {
  return (
    <div className="rounded-2xl bg-black-secondary text-white">
      <img
        className="object-cover w-full rounded-t-2xl h-[12.875rem] md:h-[13.813rem] lg:h-[296px]"
      ...
      <div className="p-[1.25rem]">
        ...
        <div className="flex justify-between items-center">
          <div className="grid gap-[0.5rem]">
            <caption className="text-gray text-[0.75] leading-[110%]">Price</caption>
            <h5 className="text-[0.75] leading-[110%] lg:text-[1rem]">1.63 ETH</h5>
          </div>
          <div className="grid gap-[0.5rem]">
            <caption className="text-gray text-[0.75] leading-[110%]">Highest Bid</caption>
            <h5 className="text-[0.75] leading-[110%] lg:text-[1rem]">0.33 wETH</h5>
          </div>
        </div>
      </div>
    </div>
