    ...
    <article className="border rounded-full border-gray">
      <div className="flex justify-between px-5 py-3 lg:px-8">
        <div className="flex gap-5 items-center">
          ...
          <p className="text-gray text-sm font-spaceMono leading-6">Artist</p>
        </div>
        <div className="flex gap-5 items-center lg:gap-8 xl:gap-12">
          <h5 className="hidden text-gray font-spaceMono text-sm leading-6 lg:flex">
            Change
          </h5>
          <h5 className="hidden text-gray font-spaceMono text-sm leading-6 xl:flex">
            NFTs Sold
          </h5>
